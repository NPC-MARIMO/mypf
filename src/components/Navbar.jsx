    ...
    >
      ...
      >
        ...
        >
          ...
          src={logo} 
          alt="logo"
          className='w-[3rem] translate-y-1 h-[4rem] object-contain'/>
          ...
          >
            ...
            <div
              className={`${!toggle ? 'hidden' : 'flex'} absolute p-6 black-gradient top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}
            >
                <ul 
